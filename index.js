var fs = require('fs');
var defaultInclude={"headlink.shtml":"./src/html/headlink.shtml","header.shtml":"./src/html/header.shtml","footer.shtml":"./src/html/footer.shtml"};
...
HtmlInludePlugin.prototype.replaceInclude = function(htmlData){
  ...
  da.forEach(function(item){
      if(!item) return;
      r = item.match(/["']([^"'\s]+)["']/);
      r&&obj.push({k:[item],v:defaultInclude[r[1]]?defaultInclude[r[1]]:r[1]});  
  });
  return obj;
};
